...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { description: @series.description, genre_id: @series.genre_id, name: @series.name } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { description: @series.description, genre_id: @series.genre_id, name: @series.name } }
